            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                    <div className="flex flex-col items-center md:items-start">
                        <a href="/"> <h2 className="text-2xl font-bold font-alt mb-2">Eljakani<span className="text-point">.</span></h2></a>
                ...
                <div className="text-center text-xs text-muted-foreground mt-4 font-alt">
                    &copy; {new Date().getFullYear()} Yassine El Jakani. All rights reserved.
                </div>
            </div>
